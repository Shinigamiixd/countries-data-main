...
btn_all.addEventListener("click", allcountries)
btn_antarctica.addEventListener("click", allcountries)
btn_afr.addEventListener("click", allcountries)
btn_asia.addEventListener("click", allcountries)
btn_eu.addEventListener("click", allcountries)
